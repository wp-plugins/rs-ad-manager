...
Upload the rsadmanager folder (not just the files in the folder) to your WordPress wp-content/plugins folder. If installed correctly, the wp-content/plugins folder should contain the rsadmanager folder. The rsadmanager folder will contain rsadmanager.php and other files.
